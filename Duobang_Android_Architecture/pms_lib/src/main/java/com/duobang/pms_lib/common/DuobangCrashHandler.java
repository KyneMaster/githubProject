...
import com.duobang.pms_lib.core.compat.SystemPropertiesCompat;
...
public class DuobangCrashHandler implements UncaughtExceptionHandler {


    private static final String TAG = "DuobangCrashHandler";
    ...
    private static final DuobangCrashHandler S_DUOBANG_CRASH_HANDLER = new DuobangCrashHandler();
    ...
    public static DuobangCrashHandler getInstance() {
        return S_DUOBANG_CRASH_HANDLER;
    }
